    ...
    class NameUniqueness {
        ...
        class ManagedTimestampingModel {
            ...
            void nonExistentProfile_throwsNotFoundException() {
                ...
                // when
                Executable getProfile = () -> signingProfileService.getManagedTimestampingProfileModel(nonExistentSigningProfileName);
            ...
            void nonTimestampingProfile_throwsNotFoundException() {
                ...
                // when
                Executable getModel = () -> signingProfileService.getManagedTimestampingProfileModel(rawProfileName);

                // then
                NotFoundException ex = assertThrows(NotFoundException.class, getModel);
        ...
        void timestamping_staticKeyScheme_returnsTypedModelWithResolvedCertificate()
            ...
            assertEquals(defaultSigningCertificate.getUuid(), schemeModel.certificate().getUuid());
        }
