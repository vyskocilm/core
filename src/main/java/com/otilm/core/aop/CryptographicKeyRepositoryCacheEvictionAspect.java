 ...
 *
 * <p>{@link com.otilm.core.model.signing.SigningCertificate} caches key-level structural
 * references ({@code tokenInstanceReferenceUuid}, {@code tokenProfileUuid}, {@code keyItemUuids})
 * derived from the associated {@link com.otilm.core.dao.entity.CryptographicKey}. When the
 * key is mutated (e.g. token-profile reassignment via
 * {@link com.otilm.core.service.impl.CryptographicKeyServiceImpl#editKey}), those cached
